...
class FlightComputer:
    ...
    def check_safety(self, telemetry):
        ...
        # Battery checks
        voltage = battery['vbat']  # Already in volts
        ...
        # Altitude check
        altitude_m = alt['estimatedAltitude']  # Already in meters
